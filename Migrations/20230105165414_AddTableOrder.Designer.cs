...
namespace ProdutosApp.Migrations
{
    ...
    [Migration("20230105165414_AddTableOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    ...
                    b.ToTable("OrderProduts", (string)null);
                });

            modelBuilder.Entity("ProdutosApp.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("ProdutosApp.Domain.Orders.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProdutosApp.Domain.Products.Product", null)
                        .WithMany()
